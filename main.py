...
pygame.display.set_caption("STREET_FIGHTER_LITE")
...
while run:
  ...
  draw_text("Player_1: " + str(score[0]), score_font, PURPLE, 20, 60)
  draw_text("Player_2: " + str(score[1]), score_font, PURPLE, 580, 60)
  ...
  if round_over == False:
    if fighter_1.alive == False:
      ...
      round_over = True
      round_over_time = pygame.time.get_ticks()
    elif fighter_1.alive == False and fighter_2.alive == False:
      score[0] += 0
      score[1] += 0
      round_over = True
      round_over_time = pygame.time.get_ticks()
